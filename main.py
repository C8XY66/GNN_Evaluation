...
parser.add_argument("--EPOCHS", type=int, default=100, help="number of epochs to train each trial of fold")
parser.add_argument("--PATIENCE", type=int, default=20, help="patience for early stopping monitoring val_acc")
